...
rhino.add_tets_from_mesh(mdl, name='elset_tets', mesh=mesh, draw_tets=None, volume=10**(-4))
...
mdl.add(Properties(name='ep_tets', material='mat_elastic', section='sec_solid', elsets='elset_tets'))
