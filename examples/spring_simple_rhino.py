...
ep_bl = Properties(name='ep_bl', material=None, section='spring_elastic', elsets='spring_bot_left')
ep_br = Properties(name='ep_br', material=None, section='spring_soft', elsets='spring_bot_right')
ep_tl = Properties(name='ep_tl', material=None, section='spring_elastic', elsets='spring_top_left')
ep_tr = Properties(name='ep_tr', material=None, section='spring_nonlinear', elsets='spring_top_right')
