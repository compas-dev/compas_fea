...
rhino.plot_data(mdl, path, name, step='step_load', field='U', component='magnitude')

# Plot stress

rhino.plot_data(mdl, path, name, step='step_load', field='S', component='mises', iptype='max')
