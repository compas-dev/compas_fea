...
mdl.add([
    Properties(name='ep_planar', material='mat_concrete', section='sec_planar', elsets='elset_mesh'),
    Properties(name='ep_plate', material='mat_steel', section='sec_planar', elsets='elset_plates'),
    Properties(name='ep_tie', material='mat_steel', section='sec_tie', elsets='elset_tie'),
])
